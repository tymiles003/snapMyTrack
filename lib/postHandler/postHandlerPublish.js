...
function updatePublishInfo(res, publishData, callback){
    ...
    if(publishData.publishPeriod==='snap'){
        publishEndTimestamp = publishEndTimestamp.setHours( publishEndTimestamp.getHours() + 200*365*24 );
    }
    else if(publishData.publishPeriod==='oneMonth'){
        publishEndTimestamp = publishEndTimestamp.setHours( publishEndTimestamp.getHours() + 30*24 );
    }
    else if(publishData.publishPeriod==='oneWeek'){
        publishEndTimestamp = publishEndTimestamp.setHours( publishEndTimestamp.getHours() + 7*24 );
    }
    else if(publishData.publishPeriod==='oneDay'){
        publishEndTimestamp = publishEndTimestamp.setHours( publishEndTimestamp.getHours() + 1*24 );
    }
    else if(publishData.publishPeriod==='oneHour'){
        publishEndTimestamp = publishEndTimestamp.setHours( publishEndTimestamp.getHours() + 1 );
    }
