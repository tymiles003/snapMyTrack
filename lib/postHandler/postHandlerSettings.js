...
function handleUserSettingsPost(app){
    ...
    var userSettings = {
        ...
        'tracksToShow' : req.body.tracksToShow
    };
    console.log('userSettings: ');
    console.log(userSettings);
    // validate user settings
    if ((userSettings.accountType === undefined) || (userSettings.userId === undefined)
         || (userSettings.mapTypeId === undefined) || (userSettings.tracksToShow === undefined) ) {
